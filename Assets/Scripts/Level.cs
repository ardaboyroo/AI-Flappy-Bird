...
public class Level : MonoBehaviour
{
    ...
    public float CAMERA_ORTHO_SIZE = 50f;
    public float PIPE_WIDTH = 7.8f;
    public float PIPE_HEAD_HEIGHT = 3.75f;
    public bool USE_CONSISTEN_GAP_SIZE = false;
    public float GAP_SIZE = 40f;
    private const float PIPE_MOVE_SPEED = 30f;
    public float PIPE_DESTROY_X_POSITION = -100f;
    public float PIPE_SPAWN_X_POSITION = +100f;
    public float GROUND_DESTROY_X_POSITION = -200f;
    public float CLOUD_DESTROY_X_POSITION = -160f;
    public float CLOUD_SPAWN_X_POSITION = +160f;
    public float CLOUD_SPAWN_Y_POSITION = +30f;
    public float BIRD_X_POSITION = 0f;
